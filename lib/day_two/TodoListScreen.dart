...
class _TodoListScreenState extends State<TodoListScreen> {
  ...
  void _pressAddTodo() async {
    setState(() {
      TodoModel model = TodoModel(title: "Create new project");
      _list.add(model);
    });
  }
      ...
      body: SafeArea(
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return TodoItem(item: item, onTapDone: (value) {
              setState(() {
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          ...
          CircleCheckbox(value: item.isDone, onChanged: onTapDone, activeColor: Colors.green,)
        ],
      ),
    );
  }
